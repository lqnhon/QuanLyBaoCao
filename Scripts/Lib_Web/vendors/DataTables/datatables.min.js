...
sNext:"Trước",sPrevious:"Sau"},sEmptyTable:"Không có dữ liệu trong bảng",sInfo:"Hiển thị từ _START_ đến _END_ của _TOTAL_ bản ghi",sInfoEmpty:"Hiển thị từ 0 đến 0 của 0 bản ghi",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Tổng số dòng trên trang _MENU_",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Tìm kiếm:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:f.extend({},q.models.oSearch),sAjaxDataProp:"data",
